...
; CHECK: call i1 @llvm.is.fpclass.f32(float %x, /* pzero|psub|pnorm|pinf */ i32 960)
; CHECK: call i1 @llvm.is.fpclass.f32(float %x, /* nzero|nsub|nnorm|ninf */ i32 60)
; CHECK: call i1 @llvm.is.fpclass.f32(float %x, /* sub|nnorm|pinf|qnan */ i32 666)
