...
; CHECK-NEXT:   %is_vec = call <4 x i1> @llvm.is.fpclass.v4f32(<4 x float> <float +snan(0x42), float poison, float 1.000000e+00, float -0.000000e+00>, /* nzero|pnorm|nan */ i32 291) => { T, poison, T, T }
; CHECK-NEXT:   ret void
