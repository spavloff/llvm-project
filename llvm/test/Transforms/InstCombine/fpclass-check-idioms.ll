...
; CHECK-NEXT:    [[CMP:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A]], /* inf|nan */ i32 519)
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %i32 = bitcast float %a to i32
  %and = and i32 %i32, 2139095040
...
; CHECK-NEXT:    [[CMP:%.*]] = call i1 @llvm.is.fpclass.f64(double [[A]], /* inf|nan */ i32 519)
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %i64 = bitcast double %a to i64
  %and = and i64 %i64, 9218868437227405312
...
; CHECK-NEXT:    [[CMP:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[A]], /* inf|nan */ i32 519)
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
  %i32 = bitcast <2 x float> %a to <2 x i32>
  %and = and <2 x i32> %i32, <i32 2139095040, i32 2139095040>
...
; CHECK-SAME: float [[A:%.*]]) {
; CHECK-NEXT:    [[CMP:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A]], /* norm|inf|nan */ i32 783)
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %i32 = bitcast float %a to i32
  %and = and i32 %i32, 2139095040
...
; CHECK-SAME: <2 x double> [[A:%.*]]) {
; CHECK-NEXT:    [[CMP:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f64(<2 x double> [[A]], /* norm|inf|nan */ i32 783)
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
  %i64 = bitcast <2 x double> %a to <2 x i64>
  %and = and <2 x i64> %i64, splat(i64 9218868437227405312)
...
; CHECK-SAME: float [[NUM:%.*]]) {
; CHECK-NEXT:    [[RES:%.*]] = call i1 @llvm.is.fpclass.f32(float [[NUM]], /* zero|sub|inf|nan */ i32 759)
; CHECK-NEXT:    ret i1 [[RES]]
;
  %cast = bitcast float %num to i32
  %masked = and i32 %cast, 2139095040
...
; CHECK-NEXT:    [[RES:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[NUM]], /* zero|sub|inf|nan */ i32 759)
; CHECK-NEXT:    ret <2 x i1> [[RES]]
;
