...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* zero|nan */ i32 99)
; CHECK-NEXT:    ret i1 [[VAL]]
;
  %val = call i1 @llvm.is.fpclass.f32(float %x, i32 99) ; fcZero|fcNan
  ret i1 %val
...
; CHECK-NEXT:    [[VAL:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[X:%.*]], /* zero|nan */ i32 99)
; CHECK-NEXT:    ret <2 x i1> [[VAL]]
;
  %val = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> %x, i32 99) ; fcZero|fcNan
  ret <2 x i1> %val
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* zero|sub|nan */ i32 243)
; CHECK-NEXT:    ret i1 [[VAL]]
;
;`
...
; CHECK-NEXT:    [[VAL:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[X:%.*]], /* zero|sub|nan */ i32 243)
; CHECK-NEXT:    ret <2 x i1> [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* zero|sub|snan */ i32 241)
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* zero|sub|qnan */ i32 242)
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* sub|norm|inf|qnan */ i32 926)
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* sub|norm|inf|snan */ i32 925)
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* sub|norm|inf */ i32 924)
; CHECK-NEXT:    ret i1 [[VAL]]
;
  %val = call i1 @llvm.is.fpclass.f32(float %x, i32 924) ; ~fcZero & ~fcNan & fcAllFlags
  ret i1 %val
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* norm|inf|nan */ i32 783)
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* norm|inf */ i32 780)
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* sub|norm|inf|nan */ i32 927) #[[ATTR0]]
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* sub|norm|inf|nan */ i32 927)
; CHECK-NEXT:    ret i1 [[VAL]]
;
  %val = call i1 @llvm.is.fpclass.f32(float %x, i32 927) ; ~fcZero & fcAllFlags
  ret i1 %val
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* pinf|nan */ i32 515) #[[ATTR0]]
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* ninf|nan */ i32 7) #[[ATTR0]]
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* inf|nan */ i32 519) #[[ATTR0]]
; CHECK-NEXT:    ret i1 [[VAL]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* zero|sub|inf|nan */ i32 759)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[X:%.*]], /* nzero|snan */ i32 33)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[X:%.*]], /* pzero|sub|norm|inf|qnan */ i32 990)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[X:%.*]], /* nzero|snan */ i32 33)
...
; CHECK-NEXT:    [[CLASS1:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A:%.*]], /* nnorm|ninf */ i32 12)
...
; CHECK-NEXT:    [[CLASS1:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[A:%.*]], /* nnorm|ninf */ i32 12)
...
; CHECK-NEXT:    [[CLASS0:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A:%.*]], /* nnorm|ninf|nan */ i32 15)
; CHECK-NEXT:    store i1 [[CLASS0]], ptr [[PTR:%.*]], align 1
; CHECK-NEXT:    [[CLASS1:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A]], /* nnorm */ i32 8)
...
; CHECK-NEXT:    [[CLASS1:%.*]] = call i1 @llvm.is.fpclass.f32(float [[B:%.*]], /* nnorm|ninf|nan */ i32 15)
; CHECK-NEXT:    [[AND:%.*]] = and i1 [[CLASS0]], [[CLASS1]]
; CHECK-NEXT:    ret i1 [[AND]]
;
  %class0 = call i1 @llvm.is.fpclass.f32(float %a, i32 7)
...
; CHECK-NEXT:    [[CLASS1:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[A:%.*]], /* nnorm|snan */ i32 9)
; CHECK-NEXT:    ret <2 x i1> [[CLASS1]]
;
  %class0 = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> %a, i32 4)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* norm|pinf */ i32 776)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* norm|ninf */ i32 268)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|psub|nnorm|pinf */ i32 680)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|psub|nnorm|pinf|snan */ i32 681)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|psub|nnorm|pinf|qnan */ i32 682)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|psub|nnorm|pinf|nan */ i32 683)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|nsub|pnorm|ninf */ i32 340)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|nsub|pnorm|ninf|snan */ i32 341)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|nsub|pnorm|ninf|qnan */ i32 342)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|nsub|pnorm|ninf|nan */ i32 343)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fneg = fneg float %arg
...
; CHECK-NEXT:    [[CLASS:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[ARG:%.*]], /* pzero|nsub|pnorm|ninf|nan */ i32 343)
; CHECK-NEXT:    ret <2 x i1> [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* norm|inf */ i32 780)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|norm|snan */ i32 361)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|norm|qnan */ i32 362)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|norm|nan */ i32 363)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* sub|inf */ i32 660)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* sub|inf|snan */ i32 661)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* sub|inf|qnan */ i32 662)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* sub|inf|nan */ i32 663)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call float @llvm.fabs.f32(float %arg)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[ARG:%.*]], /* sub|inf|nan */ i32 663)
; CHECK-NEXT:    ret <2 x i1> [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|pnorm|pinf */ i32 960)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|pnorm|pinf|snan */ i32 961)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|pnorm|pinf|qnan */ i32 962)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|pnorm|pinf|nan */ i32 963)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* psub|pnorm|pinf|snan */ i32 897)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* psub|pnorm|pinf|qnan */ i32 898)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pnorm|pinf */ i32 768)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|pinf */ i32 704)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|pinf|nan */ i32 707)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|psub|pnorm|pinf|snan */ i32 993)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|psub|pnorm|pinf|qnan */ i32 994)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|sub|norm|pinf|snan */ i32 1017)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|sub|pnorm|pinf|snan */ i32 1009)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|sub|pnorm|pinf|qnan */ i32 1010)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|sub|pnorm|pinf|nan */ i32 1011)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|psub|pnorm|pinf */ i32 928)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|nsub|pnorm|pinf */ i32 816)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|nsub|nnorm|ninf|nan */ i32 63)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|nsub|nnorm|ninf|qnan */ i32 62)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|nsub|nnorm|ninf|snan */ i32 61)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|nsub|nnorm|ninf|qnan */ i32 126)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|nsub|nnorm|ninf|snan */ i32 125)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|sub|nnorm|ninf|nan */ i32 255)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|nsub|norm|ninf|nan */ i32 319)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nzero|nsub|norm|ninf */ i32 316)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nsub|ninf|qnan */ i32 22)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nsub|nnorm|ninf|qnan */ i32 30)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nsub|nnorm|ninf|snan */ i32 29)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* ninf|qnan */ i32 6)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nnorm|ninf|qnan */ i32 14)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nnorm|ninf|snan */ i32 13)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nnorm|ninf */ i32 12)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|nsub|nnorm|ninf|nan */ i32 95)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* pzero|psub|nnorm|ninf|nan */ i32 207)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* psub|pnorm|pinf */ i32 896)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 896)
  ret i1 %class
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* psub|pnorm|pinf|nan */ i32 899)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 899)
  ret i1 %class
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|psub|pnorm|pinf */ i32 992)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 992)
  ret i1 %class
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|psub|pnorm|pinf|nan */ i32 995)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 995)
  ret i1 %class
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|nsub|nnorm|ninf|nan */ i32 127)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 127)
  ret i1 %class
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* zero|nsub|nnorm|ninf */ i32 124)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 124)
  ret i1 %class
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f32(float [[ARG:%.*]], /* nsub|nnorm|ninf */ i32 28)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %class = call i1 @llvm.is.fpclass.f32(float %arg, i32 28)
  ret i1 %class
