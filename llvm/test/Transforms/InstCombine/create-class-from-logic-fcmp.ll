...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|inf|nan */ i32 615)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f16(<2 x half> [[X:%.*]], /* zero|inf|nan */ i32 615)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|inf */ i32 612)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|pinf|nan */ i32 611)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* nsub|nnorm|inf|nan */ i32 543)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %cmpinf = fcmp ueq half %fabs, 0xH7C00
...
; CHECK-NEXT:    [[NOT_CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* sub|norm|ninf */ i32 412)
; CHECK-NEXT:    ret i1 [[NOT_CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[NOT_CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* sub|norm|nan */ i32 411)
; CHECK-NEXT:    ret i1 [[NOT_CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[AND:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* sub|norm|nan */ i32 411)
; CHECK-NEXT:    ret i1 [[AND]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %cmpzero = fcmp une half %x, 0.0
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|inf */ i32 756)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %cmpinf = fcmp oeq half %fabs, 0xH7C00
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|nnorm|inf */ i32 764)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %cmpinf = fcmp oeq half %fabs, 0xH7C00
...
; CHECK-NEXT:    [[NOT:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* norm|nan */ i32 267)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* norm|inf|nan */ i32 783)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %cmpinf = fcmp oeq half %fabs, 0xH7C00
...
; CHECK-NEXT:    [[OR:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|inf|nan */ i32 759)
; CHECK-NEXT:    ret i1 [[OR]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[OR:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* norm|inf|nan */ i32 783)
; CHECK-NEXT:    ret i1 [[OR]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %cmpinf = fcmp uge half %fabs, 0xH7C00
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[OR:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|norm|inf|nan */ i32 879)
; CHECK-NEXT:    ret i1 [[OR]]
;
entry:
  %fabs = tail call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[OR:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* norm|inf */ i32 780)
; CHECK-NEXT:    ret i1 [[OR]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
  %is.normal.inf = fcmp oge half %fabs, 0xH0400
...
; CHECK-NEXT:    [[OR:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* pnorm|inf */ i32 772)
; CHECK-NEXT:    ret i1 [[OR]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[OR:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|nnorm|inf|nan */ i32 767)
; CHECK-NEXT:    ret i1 [[OR]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[AND:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* nnorm|ninf */ i32 12)
; CHECK-NEXT:    ret i1 [[AND]]
;
  %not.is.pos.normal.inf = fcmp ult half %x, 0xH0400
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|nnorm|ninf|nan */ i32 255)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|nnorm|ninf */ i32 252)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.infinity = fcmp olt half %x, 0xH7C00
  %cmp.smallest.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* norm|ninf */ i32 268)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.infinity = fcmp olt half %x, 0xH7C00
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|sub|nnorm|inf|nan */ i32 767)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* pnorm|inf */ i32 772)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %oeq.neg.infinity = fcmp oeq half %x, 0xHFC00
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* pnorm|pinf */ i32 768)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %one.neg.infinity = fcmp one half %x, 0xHFC00
  %cmp.smallest.normal = fcmp uge half %x, 0xH0400
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|psub|pnorm|inf|nan */ i32 999)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|psub|pnorm|inf */ i32 996)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* psub|pnorm|inf */ i32 900)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp oeq half %x, 0xHFC00
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* psub|pnorm|inf|nan */ i32 903)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp ueq half %x, 0xHFC00
  %cmp.ogt.zero = fcmp ogt half %x, 0xH0000
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|nsub|nnorm|inf|nan */ i32 639)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp ueq half %x, 0xH7C00
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* zero|nsub|nnorm|inf */ i32 636)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CLASS:%.*]] = call i1 @llvm.is.fpclass.f16(half [[X:%.*]], /* nsub|nnorm|inf */ i32 540)
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp oeq half %x, 0xH7C00
