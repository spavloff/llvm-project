...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.is.fpclass.f64(double [[ARG]], /* inf|nan */ i32 519)
...
; CHECK-SAME: double [[ARG:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.is.fpclass.f64(double [[ARG]], /* zero|sub|norm|nan */ i32 507)
; CHECK-NEXT:    ret i1 [[TMP1]]
;
  %abs = tail call double @llvm.fabs.f64(double %arg)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call <4 x i1> @llvm.is.fpclass.v4f64(<4 x double> [[ARG]], /* inf|nan */ i32 519)
...
; CHECK-SAME: <4 x double> [[ARG:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call <4 x i1> @llvm.is.fpclass.v4f64(<4 x double> [[ARG]], /* zero|sub|norm|nan */ i32 507)
; CHECK-NEXT:    ret <4 x i1> [[TMP1]]
;
  %abs = tail call <4 x double> @llvm.fabs.v4f64(<4 x double> %arg)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.is.fpclass.f128(fp128 [[ARG]], /* inf|nan */ i32 519)
; CHECK-NEXT:    ret i1 [[TMP1]]
;
...
; CHECK-SAME: fp128 [[ARG:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.is.fpclass.f128(fp128 [[ARG]], /* zero|sub|norm|nan */ i32 507)
; CHECK-NEXT:    ret i1 [[TMP1]]
;
  %abs = tail call fp128 @llvm.fabs.f128(fp128 %arg)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.is.fpclass.f80(x86_fp80 [[ARG]], /* inf|nan */ i32 519)
; CHECK-NEXT:    ret i1 [[TMP1]]
;
...
; CHECK-SAME: x86_fp80 [[ARG:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.is.fpclass.f80(x86_fp80 [[ARG]], /* zero|sub|norm|nan */ i32 507)
; CHECK-NEXT:    ret i1 [[TMP1]]
;
  %abs = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %arg)
