...
; CHECK-NEXT:    [[TMP1:%.*]] = call <vscale x 2 x i1> @llvm.is.fpclass.nxv2f64(<vscale x 2 x double> [[ARG]], /* inf|nan */ i32 519)
...
; CHECK-SAME: <vscale x 2 x double> [[ARG:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call <vscale x 2 x i1> @llvm.is.fpclass.nxv2f64(<vscale x 2 x double> [[ARG]], /* zero|sub|norm|nan */ i32 507)
; CHECK-NEXT:    ret <vscale x 2 x i1> [[TMP1]]
;
  %abs = tail call <vscale x 2 x double> @llvm.fabs.nxv2f64(<vscale x 2 x double> %arg)
